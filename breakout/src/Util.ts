export namespace Util {
    ...
    export const generateQuadsBricks = (atlas: HTMLImageElement) => {
    ...
    export const generateQuadsBalls = (atlas: HTMLImageElement) => {
    ...
    export class Quad {
        sx: number;      // The x-coordinate of the quad's texture coordinates
        sy: number;      // The y-coordinate of the quad's texture coordinates
        sw: number;      // The width of the quad's texture coordinates
        sh: number;      // The height of the quad's texture coordinates
