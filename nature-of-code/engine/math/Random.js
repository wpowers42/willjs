...
export class Random {
    ...
    static random(min, max) {
        /**
         * Generates random numbers based on the provided arguments
         * @param {number|Array} [min] - Minimum value, upper bound, or array to choose from
         ...
         *  - With no args: Returns random number between 0 and 1
         */
